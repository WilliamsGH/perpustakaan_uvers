      ...
      <div class="col min-vh-70 bg-white mb-3 p-0">
        <div class="py-2 py-sm-4 px-4 d-sm-flex shadow-lg">
          <form action="" class="d-flex anggota-form-search">
            <div class="anggota-search-icon-box bg-white h-100 d-flex justify-content-center align-items-center">
          ...
          <a href="{{ url('member/create') }}"
            ...
            <img src="{{ Storage::url('img/icons/plus.svg') }}" alt="" />
              ...
              <tr>
                ...
                <td>
                  <div class="d-md-flex gap-1">
                    <a href="{{ url('/member/edit/' . $user_id->id) }}" class="d-inline-block pb-1 pb-md-0">
                      <img src="{{ Storage::url('img/icons/edit.svg') }}" alt="" class="anggota-btn-aksi" />
                    </a>
                    <form action="{{ url('/member/delete/' . $user_id->id) }}" method="post">
                      @csrf
                      <button class="btn d-inline-block pt-1 pt-md-0" type="submit">
                        <img src="{{ Storage::url('img/icons/delete.svg') }}" alt="" class="anggota-btn-aksi" />
                      </button>
                    </form>
                  </div>
                </td>
      ...
      <div class="modal-body">
        <div class="d-flex flex-row w-100 py-4">
          <div class="d-flex justify-content-center align-items-center anggota-img-konfirmasi-box">
            <img src="{{ Storage::url('img/icons/confirmation.svg') }}" class="anggota-img-konfirmasi" />
          </div>
      ...
      <div class="modal-body">
        <div class="d-flex flex-row w-100 py-4">
          <div class="d-flex justify-content-center align-items-center anggota-img-dihapus-box">
            <img src="{{ Storage::url('img/icons/trash-members.svg') }}" class="anggota-img-dihapus" />
          </div>
