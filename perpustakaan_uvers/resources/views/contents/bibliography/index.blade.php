      ...
      <div class="col min-vh-70 bg-white mb-3 p-0">
        <div class="py-2 py-sm-4 px-4 d-sm-flex shadow-lg">
          <form action="" class="d-flex biblio-form-search">
            <div class="biblio-search-icon-box bg-white h-100 d-flex justify-content-center align-items-center">
              ...
              <tr>
                ...
                <td>
                  <div class="d-md-flex gap-1">
                    <a href="{{ url('/bibliography/edit/' . $book_id->id) }}" class="d-inline-block pb-1 pb-md-0">
                      <img src="{{ Storage::url('img/icons/edit.svg') }}" alt="" class="biblio-btn-aksi" />
                    </a>
                    <form action="{{ url('/bibliography/delete/' . $book_id->id) }}" method="post">
                      @csrf
                      <button class="btn d-inline-block pt-1 pt-md-0" type="submit">
                        <img src="{{ Storage::url('img/icons/delete.svg') }}" alt="" class="biblio-btn-aksi" />
                      </button>
                    </form>
                  </div>
                </td>
      ...
      <div class="modal-body">
        <div class="d-flex flex-row w-100 py-4">
          <div class="d-flex justify-content-center align-items-center biblio-img-konfirmasi-box">
            <img src="{{ Storage::url('img/icons/confirmation.svg') }}" class="biblio-img-konfirmasi" />
          </div>
